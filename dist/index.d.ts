...
declare const readJsonAsync: <T = unknown>(fileName: string) => Promise<T | undefined>;
...
declare const simpleNumberSort: (a: null | number | undefined, b: null | number | undefined) => number;
declare const simpleStringSort: (a: null | string | undefined, b: null | string | undefined) => number;

export { type SortArgument, changeExtension, fileEmpty, fileExists, fileExistsAsync, isNodeError, joinPaths, makeDirectoryAsync, pathFormat, putError, readJsonAsync, readJsonSync, readTextFileAsync, readTextFileSync, removeFileAsync, removeFileSync, saveJson, saveJsonAsync, saveTextFileAsync, saveTextFileSync, simpleNumberSort, simpleStringSort, sortBy };
