 ...
 *
 * @example
 *     getFormattedDate('2024-01-15') → "Montag, 15. Januar, 14.30" (de)
 *
 * @example
 *     getFormattedDate('2024-01-15', 'en') → "Monday, 15. January, 14.30"
 *
 ...
 *
 * @example
 *     getFormattedDateShort('2024-01-15') → "15.1. 14.30"
 *
...
/**
 * Short date format with day, full month name, and time. Converts UTC date to Berlin timezone.
 *
 * @example
 *     getFormattedShortDateFromUTC('2024-01-15T13:30:00Z') → "15. Januar, 14.30"
 *
 ...
 *
 * @example
 *     getFormattedDateShortSeconds('2024-01-15') → "15. Januar 14.30.45"
 */
...
/** Returns relative time string (e.g., "vor 2 Stunden" or "2 hours ago"). Uses currently active locale. */
