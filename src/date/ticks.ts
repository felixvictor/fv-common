...
/**
 * The .NET DateTime epoch in ticks (January 1, 0001 00:00:00 UTC). .NET ticks are 100-nanosecond intervals since this
 * epoch. This value represents the number of ticks between .NET epoch and Unix epoch.
 *
 * Calculation: - Unix epoch: January 1, 1970 00:00:00 UTC - .NET epoch: January 1, 0001 00:00:00 UTC - Time difference:
 * 1969 years, 365.2425 days/year average (accounting for leap years) - Days between epochs: 719,162 days - In
 * 100-nanosecond ticks: 719,162 days × 24 hours × 60 min × 60 sec × 10,000,000 ticks/sec - Result:
 * 621,355,968,000,000,000 ticks
 */
 ...
 *
 * Calculation: - 1 tick = 100 nanoseconds (defined by .NET) - 1 millisecond = 1,000,000 nanoseconds - Therefore:
 * 1,000,000 ÷ 100 = 10,000 ticks per millisecond
 */
