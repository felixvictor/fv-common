...
/** Radians per segment of the wind rose. Calculated as (2π / numberSegments). */
...
/** Duration in seconds for a complete wind cycle (360° rotation). Represents 48 minutes and 55 seconds. */
const secondsForFullCircle = 2935 // 48 * 60 + 55

/** Degrees the wind rotates per second. Calculated as 360° / secondsForFullCircle. */
...
/**
 * Alternative implementation using modulo for normalization. Mathematically equivalent but more concise.
 *
 * @param wind - Current wind direction in degrees (0-360).
