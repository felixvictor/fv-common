/**
 * Generates an SVG path string for a circle. Uses arc commands to draw two semicircles.
 *
 * @example
...
/**
 * Generates an SVG path string for a rectangle. The rectangle is centered at (x, y).
 *
 * @example
...
/**
 * Generates an SVG path string for a rectangle with separate width and height. The rectangle is centered at (x, y).
 *
 * @example
